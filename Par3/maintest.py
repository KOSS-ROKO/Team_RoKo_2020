...
x1, y1, w1, h1, a1, b1, c1, d1 = 0
yellow_object, is_yellow_object, yellow_object_center, yellow_Area = 0
ACT = 0
    ...
    while True:
        ...
        if len(cnts1) > 0:
            ...
            if Area > min_area[now_color]:
                ...
                cv2.rectangle(frame, (x4, y4), (x4 + w4, y4 + h4), (0, 255, 0), 2)
                [cv2.circle(img, tuple(point), 5, (255, 0, 0), -1) for point in [a1, b1, c1, d1, yello_object_center]]
                yello_Area = Area
                #----------------------------------------
                X_Size = int((255.0 / W_View_size) * w4)
                Y_Size = int((255.0 / H_View_size) * h4)
        ...
        if key == 27:   break   # ESC key
            ...
            if View_select == 0:    View_select = 1
            else:                   View_select = 0
