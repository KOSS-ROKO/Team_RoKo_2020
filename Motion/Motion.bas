...
오른쪽옆걸음20센치:
    ...
    ' 퍼팅포즈 변경사항 있어요 (걸음 뺐어요) 완

    ' 전진기본한걸음 서브루틴 후 exit 호출 안함 오류 해결함 (꼭!! 두 번씩 확인하자 겁나 헷갈려)

    'ETX 값 바꿔놓기 (키에 맞춰서 )
    
    ' 앞 뒤로 넘어졌을 때 ETX 값 보내게 했음 (199)
...
횟수_뒤로좁은보폭2:
    ...
    보행COUNT = 보행COUNT + 1
    IF 보행COUNT > 1 THEN  GOTO 횟수_뒤로좁은보폭_2_stop
