...
# 트랙바 초기화
cv2.createTrackbar('Red1_Low_H', 'Camera', 0, 255, lambda x: None)
cv2.createTrackbar('Red1_High_H', 'Camera', 17, 255, lambda x: None)
cv2.createTrackbar('Red1_Low_S', 'Camera', 80, 255, lambda x: None)
cv2.createTrackbar('Red1_High_S', 'Camera', 120, 255, lambda x: None)
cv2.createTrackbar('Red1_Low_V', 'Camera', 210, 255, lambda x: None)
cv2.createTrackbar('Red1_High_V', 'Camera', 255, 255, lambda x: None)

cv2.createTrackbar('Red2_Low_H', 'Camera', 0, 255, lambda x: None)
cv2.createTrackbar('Red2_High_H', 'Camera', 17, 255, lambda x: None)
cv2.createTrackbar('Red2_Low_S', 'Camera', 80, 255, lambda x: None)
cv2.createTrackbar('Red2_High_S', 'Camera', 120, 255, lambda x: None)
cv2.createTrackbar('Red2_Low_V', 'Camera', 210, 255, lambda x: None)
cv2.createTrackbar('Red2_High_V', 'Camera', 255, 255, lambda x: None)
